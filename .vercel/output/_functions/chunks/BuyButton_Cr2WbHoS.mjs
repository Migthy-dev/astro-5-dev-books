import { c as createComponent, r as renderTemplate, m as maybeRenderHead, d as addAttribute, a as renderComponent, b as createAstro } from './astro/server_DzS-VHIR.mjs';
...
}, "C:/Astro/dev-books/src/components/AmazonLogo.astro", void 0);
...
const $$BuyButton = createComponent(($$result, $$props, $$slots) => {
  ...
  const storeCountry = country === SPAIN ? "spain" : "mx";
  const countryName = storeCountry === "spain" ? "Espa\xF1a" : "M\xE9xico";
...
}, "C:/Astro/dev-books/src/components/BuyButton.astro", void 0);

const $$file = "C:/Astro/dev-books/src/components/BuyButton.astro";
const $$url = undefined;
